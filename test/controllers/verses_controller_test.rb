...
class VersesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create verse" do
    assert_difference('Verse.count') do
      post verses_url, params: { verse: { book_id: @verse.book_id, chapter_id: @verse.chapter_id, number: @verse.number, verse: @verse.verse } }
    end
  ...
  test "should update verse" do
    patch verse_url(@verse), params: { verse: { book_id: @verse.book_id, chapter_id: @verse.chapter_id, number: @verse.number, verse: @verse.verse } }
